...
namespace DeployTools.Core.Tests.Services
{
    public class CoreSshIntegrationTests(ITestOutputHelper testOutputHelper)
    {
        ...
        {
            var o = new CoreSsh();
            var result = await o.ConnectAsync("3.73.118.204", "ec2-user", "E:/UserData/Nick/Secured/ntg-main.pem");
        }
        ...
        {
            var o = new CoreSsh();
            await o.ConnectAsync("3.73.118.204", "ec2-user", "E:/UserData/Nick/Secured/ntg-main.pem");

            var result = await o.RunCommandAsync("ls");
        }
        ...
        public async Task Upload()
        {
            ...
            var result =
                await o.UploadFileAsync("D:/aws/sampleapp/WebApplication1/bin/Release/net8.0/publish/appsettings.json",
        ...
        public async Task UploadDirectory()
        {
            ...
            var result =
                await o.UploadDirectoryAsync("D:/aws/sampleapp/WebApplication1/bin/Release/net8.0/publish",
                    "/home/ec2-user/test1");
        ...
        public async Task FileExists()
        {
            ...
            await o.ConnectAsync("3.79.209.195", "ec2-user", "E:/UserData/Nick/Secured/ntg-main.pem");

            var result = await o.FileExistsAsync("/home/ec2-user/index.html");
            Assert.True(result.IsSuccessful);
        ...
        public async Task DirectoryExists()
        {
            ...
            var result = await o.DirectoryExistsAsync("/home/ec2-user");
            Assert.True(result.IsSuccessful);
            Assert.True(result.ListingFound);
        }
        ...
        public async Task OrchestrateUploadAndServiceStart()
        {
            ...
            await o.ConnectAsync("18.153.102.215", "ec2-user", "E:/UserData/Nick/Secured/ntg-main.pem");
            ...
            try
            {
                var result = await o.UploadDirectoryAsync(projectFolder, deployFolder);
                Assert.True(result.IsSuccessful);

                result = await o.RunCommandAsync($"chmod +x {deployFolder}/{projectExecutable}");
                Assert.True(result.IsSuccessful);
                ...
                result = await o.UploadContentAsync(serviceContents, $"{deployFolder}/{serviceName}");
                Assert.True(result.IsSuccessful);

                result = await o.RunCommandAsync($"sudo mv {deployFolder}/{serviceName} {serviceLocation}");
                Assert.True(result.IsSuccessful);

                result = await o.RunCommandAsync("sudo systemctl daemon-reload");
                Assert.True(result.IsSuccessful);

                result = await o.RunCommandAsync($"sudo systemctl enable {serviceName}");
                Assert.True(result.IsSuccessful);

                result = await o.RunCommandAsync($"sudo systemctl start {serviceName}");
                Assert.True(result.IsSuccessful);
            ...
            catch (Exception)
            {
                ...
                {
                    result = await o.RunCommandAsync($"sudo systemctl stop {serviceName}");
                    Assert.True(result.IsSuccessful);

                    result = await o.RunCommandAsync($"sudo rm {serviceLocation}");
                    Assert.True(result.IsSuccessful);
                ...
                result = await o.DirectoryExistsAsync(deployFolder);
                Assert.True(result.IsSuccessful);

                if (result.ListingFound)
                {
                    result = await o.RunCommandAsync($"sudo rm -r -f {deployFolder}");
                    Assert.True(result.IsSuccessful);
                }
            }
